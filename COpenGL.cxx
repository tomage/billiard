...
void COpenGL::doGlutInit(int *i, char **&c) {
	glutInit(i, c);
}
...
void COpenGL::doGlutInitDisplayMode(int i) {
	glutInitDisplayMode(i);
}
...
void COpenGL::doGlutDisplayFunc(void (&func)()) {
...
void COpenGL::doGlutMotionFunc(void (&func)(int, int)) {
	glutMotionFunc(func);
}
...
void COpenGL::doGlutIdleFunc(void (&func)()) {
	glutIdleFunc(func);
}

void COpenGL::doGlutMainLoop() {
	glutMainLoop();
}

void COpenGL::doGlutDestroyWindow() {
	glutDestroyWindow(iGLwin);
}
